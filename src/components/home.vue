...
<div>
  ...
  <el-container class="home_container">
    ...
    <el-footer>
      <!--尾部导航栏-->
      <el-menu mode="horizontal" router active-text-color="black" :default-active="activePath">
        <el-menu-item index="/initPage" id="a" @click="homeClick">首页</el-menu-item>
...
export default {
  ...
  methods: {
    ...
    //获取导航栏菜单(配置axios)
    async getMenuList(){
      const { data: res} = await this.$http.get(/*API中关于菜单权限的请求地址*/'menu');
    ...
    handleSelect(key, keyPath) {
      ...
      homeClick(){//this.$router.push('/initPage');
      },
      orderClick(){
